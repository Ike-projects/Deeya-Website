...
const MarketPlace = () => {
  return (
    <>
      <section
        className="h-[408px] flex items-center text-white justify-center"
        style={{
      ...
      <section className="flex flex-col items-center justify-center gap-10 mt-[30px]">
        ...
        <div className="bg-[#ECF2EC] rounded-[14px] px-[14px] py-3 flex justify-between items-center w-[308px]">
          <input
            type="text"
            placeholder="Search for what you like to order"
            className="bg-[#ECF2EC] outline-none"
          />
          <svg
      ...
      <section className="p-[80px] font-heebo flex flex-col justify-center items-center">
        <h1 className="text-end text-h3-heading w-[1260px] mb-5">
          1-15 OF 300 RESULTS
        </h1>
        ...
        <div className="flex gap-5 mt-10 w-[800px] items-center justify-center ">
          <ul className="flex gap-[10px] ms-[250px]">
            <li className="text-ui-label-medium font-heebo w-[32px] h-[32px] p-2 rounded-full bg-[#2FB078] text-white flex items-center justify-center">
              1
            </li>
            <li className="text-ui-label-medium font-heebo w-[32px] h-[32px] p-2 rounded-full bg-[#F7F7F7] flex items-center justify-center">
              2
            </li>
            <li className="text-ui-label-medium font-heebo w-[32px] h-[32px] p-2 rounded-full bg-[#F7F7F7] flex items-center justify-center">
              3
