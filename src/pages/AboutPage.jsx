  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-3xl mx-auto my-10 md:my-20 xl:my-28 px-4 ">
        <p className="text-body-text">Deeya, established in 2023, is a promising startup that has created a platform dedicated to listing farm produce for consumers to purchase. The company emerged with a mission to bridge the gap between farmers and consumers by providing a marketplace where fresh, locally sourced products can be easily accessed. With an initial capital raise of $100,000, Deeya was able to develop and implement a unique strategy that not only addresses the needs of farmers and consumers but also promotes sustainability and supports the agricultural sector.</p>

        <p className="text-body-text mt-8"><span>
      ...
      <h2 className=" text-h2-heading  text-center">Meet the Founder Azure</h2>  
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 ">
        ...
        <p className="h-full flex items-center justify-center text-center px-7 text-white text-h3-heading">Deeya is a vision that I had for years and I’m happy that it has become a platform helping both farmers and buyers globally</p>
        </div>
      </div>
    </div>
  )
