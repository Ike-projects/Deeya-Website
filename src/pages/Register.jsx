...
const Register = () => {
  ...
  const onSubmit = async(data) => {
    ...
    // try {
    //   const response = await axios.post("https://api/register", data);
  ...
  return (
    <section className=" h-full w-full">
      <div className="w-full h-full md:flex md:flex-col xl:grid xl:grid-cols-2 xl:max-w-screen-xl md:h-[697px] mt-[40px] md:mt-[100px] mx-auto rounded-xl ">
          <div className="left-grid relative hidden md:block md:w-full md:h-40 xl:h-[697px] ">
          ...
          <div className="right-grid flex justify-center pt-[40px] xl:pt-[50px]  px-8  md:bg-CardBg">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 w-full">
              <h2 className="text-heading font-medium text-center mb-[50px] ">Register</h2>
